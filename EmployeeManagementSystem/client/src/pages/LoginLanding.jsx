...
const LoginLanding = () => {
  const portalOptions = [
 
    {
      to: "/login/admin",
      title: "Admin Portal",
      description: "Manage employees, view reports, and configure settings.",
      icon: ShieldIcon,
    },
    {
      to: "/login/employee",
      ...
      sm:p-12 lg:p-16 relative overflow-y-auto min-h-screen">
        <div className="w-full max-w-md animate-fade-in relative z-10">
            ...
            <div className="space-y-4">
              {portalOptions.map((portal) => (
                <Link key={portal.to} to={portal.to}
                  ...
                  p-5 sm:p-6 transition-all duration-300 hover:bg-indigo-50 hover:border-indigo-400"
                >
            ...
            <div className="mt-12 text-center md:text-left text-sm text-slate-400">
              <p className="text-sm text-slate-500">© {new Date().getFullYear()} GSTech. All rights reserved.</p>
            </div>
